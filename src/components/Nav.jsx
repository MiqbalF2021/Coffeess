    ...
    <nav className="bg-white mb-4 md:mb-8 lg:mb-12 font-cuy">
      <div className="max-w-screen-xl flex flex-row md:flex-row items-center justify-between mx-auto p-4 relative">
        ...
        <div
          ...
          } md:translate-x-0 transform transition-transform duration-300 md:transition-none w-1/4 h-1/2 md:w-auto md:flex flex-col md:flex-row items-end md:items-stretch fixed top-16 right-0 bg-white md:h-auto p-4 md:p-0 md:relative z-20`}
        >
          <ul className="flex flex-col md:flex-row gap-4 md:gap-10 font-bold mb-4 md:mb-0 text-center md:text-left">
            <li>
              <Link
                to="/home"
